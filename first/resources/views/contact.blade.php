...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ assert('asserts/frontend/lib/animate/animate.min.css') }}" rel="stylesheet">
        <link href="{{ assert('asserts/frontend/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
                    ...
                    <nav class="navbar navbar-light navbar-expand-xl">
                        ...
                        <div class="collapse navbar-collapse bg-light py-3" id="navbarCollapse">
                            <div class="navbar-nav mx-auto border-top">
                                ...
                                <a href="{{ route('detailpage') }}" class="nav-item nav-link">Detail Page</a>
